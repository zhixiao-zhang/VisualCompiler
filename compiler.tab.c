...
union YYSTYPE
{
#line 6 "./src/compiler.y"

pnode type_pnode;
double d;

#line 168 "compiler.tab.c"
...
{
       0,    30,    30,    34,    37,    41,    49,    52,    57,    60,
      66,    69,    73,    82,    86,    89,    93,    99,   103,   109,
     118,   128,   131,   135,   148,   152,   155,   159,   162,   165,
     169,   172,   175,   179,   182,   186,   197,   200,   205,   208,
     214,   226,   229,   232,   235,   241,   247,   253,   259,   262,
     265,   268,   278,   286,   289,   292,   300,   305,   312,   315
};
#endif
...
#line 30 "./src/compiler.y"
                   {
       (yyval.type_pnode)=newAst("Program",1,(yyvsp[0].type_pnode));
       }
#line 1446 "compiler.tab.c"
    break;

  case 3:
#line 34 "./src/compiler.y"
                             {
          (yyval.type_pnode)=newAst("ExtDefList",2,(yyvsp[-1].type_pnode),(yyvsp[0].type_pnode));
          }
...
#line 1462 "compiler.tab.c"
  ...
  case 5:
#line 41 "./src/compiler.y"
                                 {
      (yyval.type_pnode)=newAst("ExtDef",3,(yyvsp[-2].type_pnode),(yyvsp[-1].type_pnode),(yyvsp[0].type_pnode));
      if (ifvardef((yyvsp[-1].type_pnode))) {
        printf("Error type 7 at line %d:Redefined Variable '%s'\n", yylineno, (yyvsp[-1].type_pnode)->content);
        } else {
          newvar(2, (yyvsp[-2].type_pnode), (yyvsp[-1].type_pnode));
        }
      }
#line 1475 "compiler.tab.c"
  ...
  case 6:
#line 49 "./src/compiler.y"
                    {
    (yyval.type_pnode)=newAst("ExtDef",2,(yyvsp[-1].type_pnode),(yyvsp[0].type_pnode));
    }
...
#line 52 "./src/compiler.y"
                             {
    (yyval.type_pnode)=newAst("ExtDef",3,(yyvsp[-2].type_pnode),(yyvsp[-1].type_pnode),(yyvsp[0].type_pnode));
    newfunc(1, (yyvsp[-2].type_pnode));
    }
#line 1492 "compiler.tab.c"
    break;

  case 8:
#line 57 "./src/compiler.y"
                  {
          (yyval.type_pnode) = newAst("ExtDecList", 1, (yyvsp[0].type_pnode));
          }
#line 1500 "compiler.tab.c"
    break;

  case 9:
#line 60 "./src/compiler.y"
                             {
    (yyval.type_pnode) = newAst("ExtDecList", 3, (yyvsp[-2].type_pnode), (yyvsp[-1].type_pnode), (yyvsp[0].type_pnode));
    }
...
#line 66 "./src/compiler.y"
               {
         (yyval.type_pnode) = newAst("Specifire", 1, (yyvsp[0].type_pnode));
         }
...
#line 69 "./src/compiler.y"
                      {
    (yyval.type_pnode) = newAst("StructSpecifire", 1, (yyvsp[0].type_pnode));
    }
...
#line 73 "./src/compiler.y"
                                            {
               inStruc = 0;
               (yyval.type_pnode) = newAst("StructSpecifire", 5, (yyvsp[-4].type_pnode), (yyvsp[-3].type_pnode), (yyvsp[-2].type_pnode), (yyvsp[-1].type_pnode), (yyvsp[0].type_pnode));
               if (findstruc((yyvsp[-3].type_pnode))) {
                  printf("Error type 11 at line %d:Dulpicated name '%s'\n", yylineno, (yyvsp[-3].type_pnode)->content);
                } else {
                  newstruc(1, (yyvsp[-3].type_pnode));
                }
               }
...
#line 82 "./src/compiler.y"
                           {
               (yyval.type_pnode) = newAst("StructSpecifire", 2, (yyvsp[-1].type_pnode), (yyvsp[0].type_pnode));
               }
...
#line 86 "./src/compiler.y"
          {
      (yyval.type_pnode) = newAst("OptTag", 1, (yyvsp[0].type_pnode));
      }
...
#line 93 "./src/compiler.y"
       {
   (yyval.type_pnode) = newAst("Tag", 1, (yyvsp[0].type_pnode));
   }
...
#line 99 "./src/compiler.y"
          {
      (yyval.type_pnode) = newAst("VarDec", 1, (yyvsp[0].type_pnode));
...
#line 103 "./src/compiler.y"
                        {
      (yyval.type_pnode) = newAst("VarDec", 4, (yyvsp[-3].type_pnode), (yyvsp[-2].type_pnode), (yyvsp[-1].type_pnode), (yyvsp[0].type_pnode));
      (yyval.type_pnode)->content = (yyvsp[-3].type_pnode)->content;
...
#line 109 "./src/compiler.y"
                        {
      (yyval.type_pnode) = newAst("FunDec", 4, (yyvsp[-3].type_pnode), (yyvsp[-2].type_pnode), (yyvsp[-1].type_pnode), (yyvsp[0].type_pnode));
      (yyval.type_pnode)->content = (yyvsp[-3].type_pnode)->content;
      if (findfunc((yyvsp[-3].type_pnode))) {
          printf("Error type 8 line %d:Redefined Function '%s'\n ", yylineno, (yyvsp[-3].type_pnode)->content);
        } else {
          newfunc(2, (yyvsp[-3].type_pnode), (yyvsp[-1].type_pnode));
        }
      }
...
#line 118 "./src/compiler.y"
                {
           (yyval.type_pnode) = newAst("FunDec", 3, (yyvsp[-2].type_pnode), (yyvsp[-1].type_pnode), (yyvsp[0].type_pnode));
           (yyval.type_pnode)->content = (yyvsp[-2].type_pnode)->content;
           if (findfunc((yyvsp[-2].type_pnode))) {
              printf("Error type 8 line %d:Redefined Function '%s'\n ", yylineno, (yyvsp[-2].type_pnode)->content);
              } else {
                newfunc(2, (yyvsp[-2].type_pnode), (yyvsp[0].type_pnode));
              }
           }
...
#line 128 "./src/compiler.y"
                               {
       (yyval.type_pnode) = newAst("VarList", 3, (yyvsp[-2].type_pnode), (yyvsp[-1].type_pnode), (yyvsp[0].type_pnode));
       }
...
#line 131 "./src/compiler.y"
                 {
       (yyval.type_pnode) = newAst("VarList", 1, (yyvsp[0].type_pnode));
       }
...
#line 135 "./src/compiler.y"
                          {
        (yyval.type_pnode) = newAst("ParamDec", 2, (yyvsp[-1].type_pnode), (yyvsp[0].type_pnode));
        if (ifvardef((yyvsp[0].type_pnode)) || findarray((yyvsp[0].type_pnode))) {
            printf("Error type 7 at line %d:Redefined Variable '%s'\n", yylineno, (yyvsp[0].type_pnode)->content);
          } else if((yyvsp[0].type_pnode)->tag == 4) {
            newarray(2, (yyvsp[-1].type_pnode), (yyvsp[0].type_pnode));
          } else {
            newvar(2, (yyvsp[-1].type_pnode), (yyvsp[0].type_pnode));
          }
        }
...
#line 148 "./src/compiler.y"
                              {
      (yyval.type_pnode) = newAst("Compst", 4, (yyvsp[-3].type_pnode), (yyvsp[-2].type_pnode), (yyvsp[-1].type_pnode), (yyvsp[0].type_pnode));
      }
...
#line 152 "./src/compiler.y"
                       {
        (yyval.type_pnode) = newAst("StmtList", 2, (yyvsp[-1].type_pnode), (yyvsp[0].type_pnode));
        }
...
#line 159 "./src/compiler.y"
              {
    (yyval.type_pnode) = newAst("Stmt", 2, (yyvsp[-1].type_pnode), (yyvsp[0].type_pnode));
    }
...
#line 162 "./src/compiler.y"
            {
    (yyval.type_pnode) = newAst("Stmt", 1, (yyvsp[0].type_pnode));
    }
...
#line 165 "./src/compiler.y"
                     {
    (yyval.type_pnode) = newAst("Stmt", 3, (yyvsp[-2].type_pnode), (yyvsp[-1].type_pnode), (yyvsp[0].type_pnode));
    getrtype((yyvsp[-1].type_pnode));
    }
...
#line 169 "./src/compiler.y"
                                             {
    (yyval.type_pnode) = newAst("Stmt", 5, (yyvsp[-4].type_pnode), (yyvsp[-3].type_pnode), (yyvsp[-2].type_pnode), (yyvsp[-1].type_pnode), (yyvsp[0].type_pnode));
    }
...
#line 172 "./src/compiler.y"
                                 {
    (yyval.type_pnode) = newAst("Stmt", 7, (yyvsp[-6].type_pnode), (yyvsp[-5].type_pnode), (yyvsp[-4].type_pnode), (yyvsp[-3].type_pnode), (yyvsp[-2].type_pnode), (yyvsp[-1].type_pnode), (yyvsp[0].type_pnode));
    }
...
#line 179 "./src/compiler.y"
                    {
       (yyval.type_pnode) = newAst("DefList", 2, (yyvsp[-1].type_pnode), (yyvsp[0].type_pnode));
       }
...
#line 186 "./src/compiler.y"
                           {
   (yyval.type_pnode) = newAst("Def", 3, (yyvsp[-2].type_pnode), (yyvsp[-1].type_pnode), (yyvsp[0].type_pnode));
   if (ifvardef((yyvsp[-1].type_pnode)) || findarray((yyvsp[-1].type_pnode))) {
      printf("Error type 7 at line %d:Redefined Variable '%s'\n", yylineno, (yyvsp[-1].type_pnode)->content);
     } else if((yyvsp[-1].type_pnode)->tag == 4) {
        newarray(2, (yyvsp[-2].type_pnode), (yyvsp[-1].type_pnode));
     } else {
        newvar(2, (yyvsp[-2].type_pnode), (yyvsp[-1].type_pnode));
     }
   }
...
#line 197 "./src/compiler.y"
            {
       (yyval.type_pnode) = newAst("DecList", 1, (yyvsp[0].type_pnode));
       }
...
#line 200 "./src/compiler.y"
                          {
       (yyval.type_pnode) = newAst("DecList", 3, (yyvsp[-2].type_pnode), (yyvsp[-1].type_pnode), (yyvsp[0].type_pnode));
       (yyval.type_pnode)->tag = (yyvsp[0].type_pnode)->tag;
       }
...
#line 205 "./src/compiler.y"
           {
   (yyval.type_pnode) = newAst("Dec", 1, (yyvsp[0].type_pnode));
   }
...
#line 208 "./src/compiler.y"
                        {
   (yyval.type_pnode) = newAst("Dec", 3, (yyvsp[-2].type_pnode), (yyvsp[-1].type_pnode), (yyvsp[0].type_pnode));
   (yyval.type_pnode)->content = (yyvsp[-2].type_pnode)->content;
   }
...
#line 214 "./src/compiler.y"
                     {
   (yyval.type_pnode) = newAst("Exp", 3, (yyvsp[-2].type_pnode), (yyvsp[-1].type_pnode), (yyvsp[0].type_pnode));
   if ((yyvsp[-2].type_pnode)->type == NULL || (yyvsp[0].type_pnode)->type == NULL) {
      return;
    }
   if (strcmp((yyvsp[-2].type_pnode)->type, (yyvsp[0].type_pnode)->type)) {
      printf("Error type 2 at line %d:Type mismatched for for assignment.\n ", yylineno);
    }
   if (!checkleft((yyvsp[-2].type_pnode))) {
...
#line 262 "./src/compiler.y"
              {
   (yyval.type_pnode) = newAst("Exp", 2, (yyvsp[-1].type_pnode), (yyvsp[0].type_pnode));
   }
...
#line 268 "./src/compiler.y"
                  {
   (yyval.type_pnode) = newAst("Exp", 4, (yyvsp[-3].type_pnode), (yyvsp[-2].type_pnode), (yyvsp[-1].type_pnode), (yyvsp[0].type_pnode));
   if(!findfunc((yyvsp[-3].type_pnode)) && (ifvardef((yyvsp[-3].type_pnode))||findarray((yyvsp[-3].type_pnode)))) {
			printf("Error type 4 at Line %d:'%s' is not a function.\n ",yylineno,(yyvsp[-3].type_pnode)->content);
		} else if(!findfunc((yyvsp[-3].type_pnode))) {
			  printf("Error type 5 at Line %d:Undefined function %s\n ",yylineno,(yyvsp[-3].type_pnode)->content);
    } else if(checkrtype((yyvsp[-3].type_pnode),(yyvsp[-1].type_pnode))){
...
#line 278 "./src/compiler.y"
             {
   (yyval.type_pnode) = newAst("Exp", 3, (yyvsp[-2].type_pnode), (yyvsp[-1].type_pnode), (yyvsp[0].type_pnode));
   if(!findfunc((yyvsp[-2].type_pnode)) && (ifvardef((yyvsp[-2].type_pnode))||findarray((yyvsp[-2].type_pnode)))) {
			printf("Error type 4 at Line %d:'%s' is not a function.\n ",yylineno,(yyvsp[-2].type_pnode)->content);
		} else if(!findfunc((yyvsp[-2].type_pnode))) {
			  printf("Error type 5 at Line %d:Undefined function %s\n ",yylineno,(yyvsp[-2].type_pnode)->content);
		} else{}
   }
#line 1923 "compiler.tab.c"
    break;
...
#line 292 "./src/compiler.y"
       {
   (yyval.type_pnode) = newAst("Exp", 1, (yyvsp[0].type_pnode));
   if (!ifvardef((yyvsp[0].type_pnode)) && !findarray((yyvsp[0].type_pnode))) {
      printf("Error type 1 at line %d:Undefined Variable %s\n ", yylineno, (yyvsp[0].type_pnode)->content);
    } else {
      (yyval.type_pnode)->type = typevar((yyvsp[0].type_pnode));
    }
   }
...
#line 305 "./src/compiler.y"
   ...
   (yyval.type_pnode)->value = (yyvsp[0].type_pnode)->value;
   }
...
#line 312 "./src/compiler.y"
                    {
    (yyval.type_pnode) = newAst("Args", 3, (yyvsp[-2].type_pnode), (yyvsp[-1].type_pnode), (yyvsp[0].type_pnode));
    }
...
#line 315 "./src/compiler.y"
         {
    (yyval.type_pnode)=newAst("Args", 1, (yyvsp[0].type_pnode));
    }
